...
**`correct.points()`** - function used within site/fs_version corrected plotting to account for these parameter's estimate's effects on each data point. Expects `re()` to be used when fitting random effect of site. Can also be called on it's own. Returns new df with each subject's phenotype corrected.
